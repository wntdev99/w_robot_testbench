...
import {
  LayoutDashboard, Cpu, Rocket, Gamepad2, Settings2, LineChart, Wrench,
} from "lucide-react";
...
const NAV = [
  ...
  { href: "/motion", label: "모터·제어", icon: Settings2 },
  { href: "/plots", label: "측정·플롯", icon: LineChart },
  { href: "/command", label: "명령", icon: Wrench },
];
